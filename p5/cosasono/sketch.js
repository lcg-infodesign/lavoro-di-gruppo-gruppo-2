...
image(imgCosa4, 1050 + cos(time + 5) * floatAmplitude, 1200 + sin(time + 5) * floatAmplitude, imgCosa4.width * scaleFactor, imgCosa4.height * scaleFactor);
...
image(imgCosasuolo, 0, 4390, imgCosasuolo.width * 0.2, imgCosasuolo.height * 0.2);
image(imgcosaastronauta, 840 + cos(time + 7) * floatAmplitude, 3100 + sin(time + 7) * floatAmplitude, imgcosaastronauta.width * scaleFactor, imgcosaastronauta.height * scaleFactor);
