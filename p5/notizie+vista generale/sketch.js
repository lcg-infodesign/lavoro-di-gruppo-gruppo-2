  ...
  if (mouseDist > sizes.radius + dotOffset && mouseDist < sizes.radius + sizes.rayLength) {
    for (let i = 0; i < 99; i++) {
      ...
      if (mouseAngle >= angle1 && mouseAngle < angle2) {
        ...
        if (countryName === "ABCASIA (GEORGIA)") { // Assicurati che il codice paese sia corretto
          if (mouseIsPressed) {
            window.location.href = '../grafico Abcasia/index.html'; // Reindirizza alla pagina
          }
        }
        ...
        if (countryName === "ALLEANZA ASIATICA") {
          if (mouseIsPressed) {
        ...
        if (countryName === 'ASCENTION ISLAND') {
          if (mouseIsPressed) {
        ...
        if (countryName === 'COREA DEL NORD') {
          if (mouseIsPressed) {
            window.location.href = '../grafico COREA DEL NORD/index.html'; 
          }
        }
        if (countryName === 'COREA DEL SUD') {
          if (mouseIsPressed) {
        ...
        if (countryName === 'EGITTO') {
          if (mouseIsPressed) {
            window.location.href = '../grafico EGITTO/index.html'; 
          }
        }
        if (countryName === 'EMIRATI ARABI UNITI') {
          if (mouseIsPressed) {
